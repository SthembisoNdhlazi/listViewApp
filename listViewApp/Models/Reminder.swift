...
extension Reminder{
    static var sampleData = [
            ...
            Reminder( title: "Call glucode", dueDate: Date().addingTimeInterval(101000.1), notes: "Ask about internship"),
            Reminder(title: "Attend iOS lecture", dueDate: Date().addingTimeInterval(52000.0),notes: "Learn more things because you know nothing"),
            Reminder(title: "Call Mom", dueDate: Date().addingTimeInterval(60000.0),notes: "Ask mom if she needs some cash and if she is okay"),
            Reminder(title: "Go to the doctor", dueDate: Date(),notes: "Go for your checkup")
...
#endif
//we have the keys and values... key:value... title:"Hi"
